 ...
 */
  ...
  static void tmc_debug_loop(
    ...
    LIST_N(NON_E_AXES, const bool print_x, const bool print_y, const bool print_z, const bool print_i, const bool print_j, const bool print_k),
    const bool print_e
  ) {
    if (print_x) {
      #if AXIS_IS_TMC(X)
  ...
  void tmc_report_all(
    ...
    #define TMC_REPORT(LABEL, ITEM) do{ SERIAL_ECHOPGM(LABEL);  tmc_debug_loop(ITEM, LIST_N(NON_E_AXES, print_x, print_y, print_z, print_i, print_j, print_k), print_e); }while(0)
    #define DRV_REPORT(LABEL, ITEM) do{ SERIAL_ECHOPGM(LABEL); drv_status_loop(ITEM, LIST_N(NON_E_AXES, print_x, print_y, print_z, print_i, print_j, print_k), print_e); }while(0)
  ...
  void tmc_get_registers(
    LIST_N(NON_E_AXES, bool print_x, bool print_y, bool print_z, bool print_i, bool print_j, bool print_k),
    bool print_e
  ) {
    #define _TMC_GET_REG(LABEL, ITEM) do{ SERIAL_ECHOPGM(LABEL); tmc_get_registers(ITEM, LIST_N(NON_E_AXES, print_x, print_y, print_z, print_i, print_j, print_k), print_e); }while(0)
...
void test_tmc_connection(
  LIST_N(NON_E_AXES, const bool test_x, const bool test_y, const bool test_z, const bool test_i, const bool test_j, const bool test_k),
  const bool test_e
) {
